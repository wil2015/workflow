...
const columns = [
  ...
  { data: 'data_formatada', title: 'Criacao' },
  {
    data: 'status_atual',
    title: 'Status',
    render: d => {
      const bg = d === 'Finalizado' ? '#d4edda' : '#e3f2fd';
      const color = d === 'Finalizado' ? '#155724' : '#0d47a1';
  ...
  { data: null, title: 'Acao', render: '#action', orderable: false }
];
