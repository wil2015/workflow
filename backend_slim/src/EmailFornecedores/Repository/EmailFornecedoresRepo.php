...
class EmailFornecedoresRepo extends BaseRepository
{
    ...
    public function upsertEmailMestre($codFornecedor, string $email): void
    {
    ...
    public function buscarEmailsParaSelecao($idProcesso): array
    {
        $sql = "SELECT lp.id as id_participante, lp.nome_do_fornecedor, lp.id_fornecedor_senior, ef.email_fornecedor,
    ...
    public function limparSelecaoAnterior($idProcesso): void
    {
