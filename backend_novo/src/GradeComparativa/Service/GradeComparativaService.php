...
namespace GradeComparativa\Service;
...
{
    private GradeComparativaRepo $repo;
    ...
    public function montarGradeParaFront($idProcesso): array
    {
        return $this->logicaDeMontagem((int)$idProcesso);
    }

    public function consolidarProcesso($idProcesso, $ofertas = []): array
    {
    ...
    private function logicaDeMontagem(int $idProcesso): array
    {
