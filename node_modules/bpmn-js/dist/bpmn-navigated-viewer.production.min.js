...
/**
   ...
   */
function(e){const t=He('<a href="http://bpmn.io" target="_blank" class="bjs-powered-by" title="Powered by bpmn.io" >'+Nr+"</a>");Re(Ke("svg",t),Br),Re(t,Lr,{position:"absolute",bottom:"15px",right:"15px",zIndex:"100"}),e.appendChild(t),je.bind(t,"click",(function(e){Wr(),e.preventDefault()}))}(this._container),this._init(this._container,this._moddle,e)}function Gr(e,t){return e.warnings=t,e}e(zr,hi),zr.prototype.importXML=async function(e,t){const n=this;let i=[];try{let o;e=this._emit("import.parse.start",{xml:e})||e;try{o=await this._moddle.fromXML(e,"bpmn:Definitions")}catch(e){throw this._emit("import.parse.complete",{error:e}),e}let a=o.rootElement;const s=o.references,l=o.warnings,p=o.elementsById;i=i.concat(l),a=this._emit("import.parse.complete",(r={error:null,definitions:a,elementsById:p,references:s,warnings:i},n.get("eventBus").createEvent(r)))||a;const c=await this.importDefinitions(a,t);return i=i.concat(c.warnings),this._emit("import.done",{error:null,warnings:i}),{warnings:i}}catch(e){let t=e;throw i=i.concat(t.warnings||[]),Gr(t,i),t=function(e){const t=/unparsable content <([^>]+)> detected([\s\S]*)$/.exec(e.message);t&&(e.message="unparsable content <"+t[1]+"> detected; this may indicate an invalid BPMN 2.0 diagram file"+t[2]);return e}(t),this._emit("import.done",{error:t,warnings:t.warnings}),t}var r},zr.prototype.importDefinitions=async function(e,t){this._setDefinitions(e);return{warnings:(await this.open(t)).warnings}},zr.prototype.open=async function(e){const t=this._definitions;let n=e;if(!t){const e=new Error("no XML imported");throw Gr(e,[]),e}if("string"==typeof e&&(n=function(e,t){if(!t)return null;return c(e.diagrams,(function(e){return e.id===t}))||null}(t,e),!n)){const t=new Error("BPMNDiagram <"+e+"> not found");throw Gr(t,[]),t}try{this.clear()}catch(e){throw Gr(e,[]),e}const{warnings:i}=await Dr(this,t,n);return{warnings:i}},zr.prototype.saveXML=async function(e){e=e||{};let t,n,i=this._definitions;try{if(!i)throw new Error("no definitions loaded");i=this._emit("saveXML.start",{definitions:i})||i;n=(await this._moddle.toXML(i,e)).xml,n=this._emit("saveXML.serialized",{xml:n})||n}catch(e){t=e}const r=t?{error:t}:{xml:n};if(this._emit("saveXML.done",r),t)throw t;return r},zr.prototype.saveSVG=async function(){let e,t;this._emit("saveSVG.start");try{const t=this.get("canvas"),n=t.getActiveLayer(),i=Ke("defs",t._svg),r=re(n),o=i?"<defs>"+re(i)+"</defs>":"",a=n.getBBox();e='<?xml version="1.0" encoding="utf-8"?>\n\x3c!-- created with bpmn-js / http://bpmn.io --\x3e\n<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">\n<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="'+a.width+'" height="'+a.height+'" viewBox="'+a.x+" "+a.y+" "+a.width+" "+a.height+'" version="1.1">'+o+r+"</svg>"}catch(e){t=e}if(this._emit("saveSVG.done",{error:t,svg:e}),t)throw t;return{svg:e}},zr.prototype._setDefinitions=function(e){this._definitions=e},zr.prototype.getModules=function(){return this._modules},zr.prototype.clear=function(){this.getDefinitions()&&hi.prototype.clear.call(this)},zr.prototype.destroy=function(){hi.prototype.destroy.call(this),Ue(this._container)},zr.prototype.on=function(e,t,n,i){return this.get("eventBus").on(e,t,n,i)},zr.prototype.off=function(e,t){this.get("eventBus").off(e,t)},zr.prototype.attachTo=function(e){if(!e)throw new Error("parentNode required");this.detach(),e.get&&e.constructor.prototype.jquery&&(e=e.get(0)),"string"==typeof e&&(e=Ke(e)),e.appendChild(this._container),this._emit("attach",{}),this.get("canvas").resized()},zr.prototype.getDefinitions=function(){return this._definitions},zr.prototype.detach=function(){const e=this._container,t=e.parentNode;t&&(this._emit("detach",{}),t.removeChild(e))},zr.prototype._init=function(e,t,n){const i=n.modules||this.getModules(n),r=n.additionalModules||[],o=[].concat([{bpmnjs:["value",this],moddle:["value",t]}],i,r),a=w(function(e,t){let n={};return h(Object(e),(function(e,i){-1===t.indexOf(i)&&(n[i]=e)})),n}(n,["additionalModules"]),{canvas:w({},n.canvas,{container:e}),modules:o});hi.call(this,a),n&&n.container&&this.attachTo(n.container)},zr.prototype._emit=function(e,t){return this.get("eventBus").fire(e,t)},zr.prototype._createContainer=function(e){const t=He('<div class="bjs-container"></div>');return Re(t,{width:Hr(e.width),height:Hr(e.height),position:e.position}),t},zr.prototype._createModdle=function(e){return new Cr(w({},this._moddleExtensions,e.moddleExtensions))},zr.prototype._modules=[];const $r={width:"100%",height:"100%",position:"relative"};function Hr(e){return e+(a(e)?"px":"")}function Kr(e){zr.call(this,e)}e(Kr,zr),Kr.prototype._modules=[At,mt,Ht,Jt,vn],Kr.prototype._moddleExtensions={};var Ur=["c","C"],qr=["v","V"],Yr=["y","Y"],Xr=["z","Z"];function Zr(e){return!e.altKey&&(e.ctrlKey||e.metaKey)}function Jr(e,t){return-1!==(e=r(e)?e:[e]).indexOf(t.key)||-1!==e.indexOf(t.code)}function Qr(e){return e.shiftKey}var eo="keyboard.keydown",to="input-handle-modified-keys";function no(e,t){var n=this;this._config=e||{},this._eventBus=t,this._keydownHandler=this._keydownHandler.bind(this),this._keyupHandler=this._keyupHandler.bind(this),t.on("diagram.destroy",(function(){n._fire("destroy"),n.unbind()})),t.on("diagram.init",(function(){n._fire("init")})),t.on("attach",(function(){e&&e.bindTo&&n.bind(e.bindTo)})),t.on("detach",(function(){n.unbind()}))}no.$inject=["config.keyboard","eventBus"],no.prototype._keydownHandler=function(e){this._keyHandler(e,eo)},no.prototype._keyupHandler=function(e){this._keyHandler(e,"keyboard.keyup")},no.prototype._keyHandler=function(e,t){if(!this._isEventIgnored(e)){var n={keyEvent:e};this._eventBus.fire(t||eo,n)&&e.preventDefault()}},no.prototype._isEventIgnored=function(e){return!!e.defaultPrevented||(t=e.target)&&(De(t,"input, textarea")||"true"===t.contentEditable)&&this._isModifiedKeyIgnored(e);var t},no.prototype._isModifiedKeyIgnored=function(e){return!Zr(e)||-1===this._getAllowedModifiers(e.target).indexOf(e.key)},no.prototype._getAllowedModifiers=function(e){var t=Te(e,"["+to+"]",!0);return!t||this._node&&!this._node.contains(t)?[]:t.getAttribute(to).split(",")},no.prototype.bind=function(e){this.unbind(),this._node=e,je.bind(e,"keydown",this._keydownHandler),je.bind(e,"keyup",this._keyupHandler),this._fire("bind")},no.prototype.getBinding=function(){return this._node},no.prototype.unbind=function(){var e=this._node;e&&(this._fire("unbind"),je.unbind(e,"keydown",this._keydownHandler),je.unbind(e,"keyup",this._keyupHandler)),this._node=null},no.prototype._fire=function(e){this._eventBus.fire("keyboard."+e,{node:this._node})},no.prototype.addListener=function(e,t,n){s(e)&&(n=t,t=e,e=1e3),this._eventBus.on(n||eo,e,t)},no.prototype.removeListener=function(e,t){this._eventBus.off(t||eo,e)},no.prototype.hasModifier=function(e){return e.ctrlKey||e.metaKey||e.shiftKey||e.altKey},no.prototype.isCmd=Zr,no.prototype.isShift=Qr,no.prototype.isKey=Jr;function io(e,t){var n=this;e.on("editorActions.init",500,(function(e){var i=e.editorActions;n.registerBindings(t,i)}))}io.$inject=["eventBus","keyboard"],io.prototype.registerBindings=function(e,t){function n(n,i){t.isRegistered(n)&&e.addListener(i)}n("undo",(function(e){if(function(e){return Zr(e)&&!Qr(e)&&Jr(Xr,e)}(e.keyEvent))return t.trigger("undo"),!0})),n("redo",(function(e){if(function(e){return Zr(e)&&(Jr(Yr,e)||Jr(Xr,e)&&Qr(e))}(e.keyEvent))return t.trigger("redo"),!0})),n("copy",(function(e){if(function(e){return Zr(e)&&Jr(Ur,e)}(e.keyEvent))return t.trigger("copy"),!0})),n("paste",(function(e){if(function(e){return Zr(e)&&Jr(qr,e)}(e.keyEvent))return t.trigger("paste"),!0})),n("stepZoom",(function(e){var n=e.keyEvent;if(Jr(["+","Add","="],n)&&Zr(n))return t.trigger("stepZoom",{value:1}),!0})),n("stepZoom",(function(e){var n=e.keyEvent;if(Jr(["-","Subtract"],n)&&Zr(n))return t.trigger("stepZoom",{value:-1}),!0})),n("zoom",(function(e){var n=e.keyEvent;if(Jr("0",n)&&Zr(n))return t.trigger("zoom",{value:1}),!0})),n("removeSelection",(function(e){if(Jr(["Backspace","Delete","Del"],e.keyEvent))return t.trigger("removeSelection"),!0}))};var ro={__init__:["keyboard","keyboardBindings"],keyboard:["type",no],keyboardBindings:["type",io]},oo={moveSpeed:50,moveSpeedAccelerated:200};function ao(e,t,n){var i=this;this._config=w({},oo,e||{}),t.addListener((function(e){var n=e.keyEvent,r=i._config;if(!t.isCmd(n))return;if(t.isKey(["ArrowLeft","Left","ArrowUp","Up","ArrowDown","Down","ArrowRight","Right"],n)){var o,a=t.isShift(n)?r.moveSpeedAccelerated:r.moveSpeed;switch(n.key){case"ArrowLeft":case"Left":o="left";break;case"ArrowUp":case"Up":o="up";break;case"ArrowRight":case"Right":o="right";break;case"ArrowDown":case"Down":o="down"}return i.moveCanvas({speed:a,direction:o}),!0}})),this.moveCanvas=function(e){var t=0,i=0,r=e.speed/Math.min(Math.sqrt(n.viewbox().scale),1);switch(e.direction){case"left":t=r;break;case"up":i=r;break;case"right":t=-r;break;case"down":i=-r}n.scroll({dx:t,dy:i})}}ao.$inject=["config.keyboardMove","keyboard","canvas"];var so={__depends__:[ro],__init__:["keyboardMove"],keyboardMove:["type",ao]},lo=/^djs-cursor-.*$/;function po(e){var t=Me(document.body);t.removeMatching(lo),e&&t.add("djs-cursor-"+e)}var co=5e3;function uo(e,t){return{x:e.x-t.x,y:e.y-t.y}}function ho(e,t){var n;function i(i){var r,o=n.start,a=n.button,s=Rt(i),l=uo(s,o);(!n.dragging&&(r=l,Math.sqrt(Math.pow(r.x,2)+Math.pow(r.y,2))>15)&&(n.dragging=!0,0===a&&function(e,t){function n(){return!1}t=t||"element.click",e.once(t,co,n)}(e),po("grab")),n.dragging)&&(l=uo(s,n.last||n.start),t.scroll({dx:l.x,dy:l.y}),n.last=s);i.preventDefault()}function r(e){je.unbind(document,"mousemove",i),je.unbind(document,"mouseup",r),n=null,po(null)}e.on("element.mousedown",500,(function(e){return function(e){if(Te(e.target,".djs-draggable"))return;var t=e.button;if(t>=2||e.ctrlKey||e.shiftKey||e.altKey)return;return n={button:t,start:Rt(e)},je.bind(document,"mousemove",i),je.bind(document,"mouseup",r),!0}(e.originalEvent)})),this.isActive=function(){return!!n}}ho.$inject=["eventBus","canvas"];var mo={__init__:["moveCanvas"],moveCanvas:["type",ho]};function fo(e){return Math.log(e)/Math.log(10)}function yo(e,t){var n=fo(e.min),i=fo(e.max);return(Math.abs(n)+Math.abs(i))/t}var go=Math.sign||function(e){return e>=0?1:-1},vo={min:.2,max:4};function xo(e,t,n){e=e||{},this._enabled=!1,this._canvas=n,this._container=n._container,this._handleWheel=b(this._handleWheel,this),this._totalDelta=0,this._scale=e.scale||.75;var i=this;t.on("canvas.init",(function(t){i._init(!1!==e.enabled)}))}xo.$inject=["config.zoomScroll","eventBus","canvas"],xo.prototype.scroll=function(e){this._canvas.scroll(e)},xo.prototype.reset=function(){this._canvas.zoom("fit-viewport")},xo.prototype.zoom=function(e,t){var n=yo(vo,20);this._totalDelta+=e,Math.abs(this._totalDelta)>.1&&(this._zoom(e,t,n),this._totalDelta=0)},xo.prototype._handleWheel=function(e){if(!Te(e.target,".djs-scrollable",!0)){var t=this._container;e.preventDefault();var n,i=e.ctrlKey||Ct()&&e.metaKey,r=e.shiftKey,o=-1*this._scale;if(o*=i?0===e.deltaMode?.02:.32:0===e.deltaMode?1:16,i){var a=t.getBoundingClientRect(),s={x:e.clientX-a.left,y:e.clientY-a.top};n=Math.sqrt(Math.pow(e.deltaY,2)+Math.pow(e.deltaX,2))*go(e.deltaY)*o,this.zoom(n,s)}else n=r?{dx:o*e.deltaY,dy:0}:{dx:o*e.deltaX,dy:o*e.deltaY},this.scroll(n)}},xo.prototype.stepZoom=function(e,t){var n=yo(vo,10);this._zoom(e,t,n)},xo.prototype._zoom=function(e,t,n){var i=this._canvas,r=e>0?1:-1,o=fo(i.zoom()),a=Math.round(o/n)*n;a+=n*r;var s,l,p=Math.pow(10,a);i.zoom((s=vo,l=p,Math.max(s.min,Math.min(s.max,l))),t)},xo.prototype.toggle=function(e){var t=this._container,n=this._handleWheel,i=this._enabled;return void 0===e&&(e=!i),i!==e&&je[e?"bind":"unbind"](t,"wheel",n,!1),this._enabled=e,e},xo.prototype._init=function(e){this.toggle(e)};var bo={__init__:["zoomScroll"],zoomScroll:["type",xo]};function wo(e){Kr.call(this,e)}return e(wo,Kr),wo.prototype._navigationModules=[so,mo,bo],wo.prototype._modules=[].concat(Kr.prototype._modules,wo.prototype._navigationModules),wo}));
