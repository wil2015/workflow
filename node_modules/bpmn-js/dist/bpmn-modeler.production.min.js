...
/*! Hammer.JS - v2.0.7 - 2016-04-22
  ...
  `}function Hc(e){const{selectedEntry:t,setSelectedEntry:n,entries:i,...r}=e,o=kc(),a=Ac((()=>function(e){const t=[],n=e=>t.find((t=>e.id===t.id)),i=e=>!!n(e),r=e=>"string"==typeof e?{id:e}:e;return e.forEach((e=>{const o=e.group?r(e.group):{id:"default"};i(o)?n(o).entries.push(e):t.push({...o,entries:[e]})})),t}(i)),[i]);return Pc((()=>{const e=o.current;if(!e)return;const t=e.querySelector(".selected");var n;t&&("function"==typeof(n=t).scrollIntoViewIfNeeded?n.scrollIntoViewIfNeeded():n.scrollIntoView({scrollMode:"if-needed",block:"nearest"}))}),[t]),vc`
  ...
  `}function Gc(e){const{onClose:t,onSelect:n,className:i,headerEntries:r,position:o,title:a,width:c,scale:p,search:l,entries:u,onOpened:h,onClosed:d}=e,f=Ac((()=>!!s(l)&&u.length>5),[l,u]),m=kc(),[v,y]=Rc(""),g=Mc(((e,t)=>{if(!f)return e;return e.filter((e=>{if(!t)return(e.rank||0)>=0;const n=[e.description||"",e.label||"",e.search||""].join("---").toLowerCase();return t.toLowerCase().split(/\s/g).every((e=>n.includes(e)))}))}),[f]),[b,x]=Rc(g(u,v)),[_,E]=Rc(b[0]),w=Mc((e=>{_&&e.includes(_)||E(e[0]),x(e)}),[_,x,E]);Tc((()=>{w(g(u,v))}),[v,u]),Tc((()=>{const e=e=>{if("Escape"===e.key)return e.preventDefault(),t()};return document.documentElement.addEventListener("keydown",e),()=>{document.documentElement.removeEventListener("keydown",e)}}),[]),Pc((()=>{m.current&&m.current.focus()}),[]);const S=Mc((e=>{let t=b.indexOf(_)+e;t<0&&(t=b.length-1),t>=b.length&&(t=0),E(b[t])}),[b,_,E]),C=Mc((e=>"Enter"===e.key&&_?n(e,_):"ArrowUp"===e.key||"Tab"===e.key&&e.shiftKey?(S(-1),e.preventDefault()):"ArrowDown"===e.key||"Tab"===e.key?(S(1),e.preventDefault()):void 0),[n,t,_,S]),R=Mc((e=>{J(e.target,"input")&&y((()=>e.target.value))}),[y]);Tc((()=>(h(),()=>{d()})),[]);const T=Ac((()=>a||r.length>0),[a,r]);return vc`
    <${Vc}
      onClose=${t}
      onKeyup=${R}
      onKeydown=${C}
  ...
  `}function Vc(e){const{onClose:t,onKeydown:n,onKeyup:i,className:r,children:o,position:a}=e,s=kc(),c=Mc((e=>{ee(e.target,".djs-popup",!0)||t()}),[t]);return Pc((()=>{if("function"!=typeof a)return;const e=s.current,t=a(e);e.style.left=`${t.x}px`,e.style.top=`${t.y}px`}),[s.current,a]),Pc((()=>{s.current&&s.current.focus()}),[]),vc`
    <div
